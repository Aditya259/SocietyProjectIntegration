          ...
          serviceList.contains("DNO Re-Generate")){ %> <a href='#'><img
			...
			<%if(serviceList!=null && 
				...
				<%if(serviceList!=null &&  serviceList.contains("Maturity Master")){ %>
					...
					<li><a href="MaturityReceiptRePrint"><i
