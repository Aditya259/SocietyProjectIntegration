      ...
      <ul class="sidebar-menu tree" data-widget="tree">
         ...
         <li class="treeview">
            ...
            <ul class="treeview-menu">
               ...
               <li><a href="memberAllDetails"><i class="fa fa-circle-o"></i>Member Summary</a></li>
               <li><a href="memberDetailRpt"><i class="fa fa-circle-o"></i>Member Report</a></li>
               <li><a href="searchMember"><i class="fa fa-circle-o"></i>Search Member</a></li>
            </ul>
         </li>
         <li class="treeview">
         ...
         <li class="treeview">
            ...
            <ul class="treeview-menu">
               ...
               <li><a href="addEmployee"><i class="fa fa-circle-o"></i>Add Employee</a></li>
               <li><a href="EmployeeIDCardPrinting"><i class="fa fa-circle-o"></i>Employee I-Card</a></li>
               <li><a href="SearchEmployee"><i class="fa fa-circle-o"></i>Search Employee</a></li>
            </ul>
         </li>
         <li class="treeview">
            ...
            <ul class="treeview-menu">
               ...
               <li><a href="rDRenewal"><i class="fa fa-circle-o"></i>Renewal Payment</a></li>
               <li><a href="dailyRenewalPayment"><i class="fa fa-circle-o"></i>Daily Renewal Payment</a></li>
               ...
               <li><a href="investmentInterestPayable"><i class="fa fa-circle-o"></i>Interest Payable</a></li>
               <li><a href="investmentSearch"><i class="fa fa-circle-o"></i>Investment Search</a></li>
            </ul>
         </li>
         <li class="treeview">
            ...
            <ul class="treeview-menu">
               ...
               <li><a href="savingsTransactionEntry"><i class="fa fa-circle-o"></i>Savings Transaction</a></li>
               <li><a href="savingIntraTransfer"><i class="fa fa-circle-o"></i>SB Intra Transfer</a></li>
               <li><a href="sBInterestGenerate"><i class="fa fa-circle-o"></i>SB Interest Transfer</a></li>
               <li><a href="sBPassbookPrint"><i class="fa fa-circle-o"></i>Savings Passbook</a></li>
               <li><a href="savingsStatement"><i class="fa fa-circle-o"></i>Savings Statement</a></li>
               <li><a href="accountCloser"><i class="fa fa-circle-o"></i>Account Closer</a></li>
               <li><a href="searchSavingsAccount"><i class="fa fa-circle-o"></i>Search Savings AC</a></li>
               <li><a href="sMSChargesDeduction"><i class="fa fa-circle-o"></i>SMS Charges Deduction</a></li>
               <li><a href="serviceChargesDeduction"><i class="fa fa-circle-o"></i>Service Charges Deduction</a></li>
            </ul>
         </li>
         <li class="treeview">
