...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/ClosedLoanReport.aspx?Type=Gold" id="form1">
...
//]]>
	...
	<option value="001">Main Office - 001</option>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label></label>
                                <a id="ContentPlaceHolder1_btnSearch" class="btn btn-success margin-20" href=""><span class="fa fa-search"></span> SEARCH</a>
                            </div>
