...
<html class="no-js" lang="">
   ...
   <body style="background: #f5f6f6;">
      ...
      <form method="post" action="loginValidate" id="form1" modelAttribute="user">
         ...
         <section class="fxt-template-animation fxt-template-layout1" style="background: url(img/figure/about-bg.png) no-repeat;">
                                 ...
                                 <div class="fxt-form">
                                    ...
                                    <div class="form-group">
                                       <div class="fxt-transformY-50 fxt-transition-delay-1">
                                          <input name="txtusername" type="text" id="txtusername" class="form-control" placeholder="User ID" />
                                          <span id="rfvloginuser" style="color:Red;font-family:Papyrus;font-size:X-Small;font-weight:bold;display:none;">Enter User Name</span>
                                    ...
                                    <div class="form-group">
                                       <div class="fxt-transformY-50 fxt-transition-delay-2">
                                          ...
                                          <span id="rfvloginPassword" style="color:Red;font-family:Papyrus;font-size:X-Small;font-weight:bold;display:none;">Enter Password</span>
                                    ...
                                    <%if(msg !=null){%>
                                    <center><h6><b style="color:red"><%=msg %></b></h6></center>
                                    <%} %>
                                    <div class="form-group">
                                       <div class="fxt-transformY-50 fxt-transition-delay-3">
                                          <div class="fxt-content-between">
                                             <input type="submit" name="btnLogin" value="Login" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;btnLogin&quot;, &quot;&quot;, true, &quot;A&quot;, &quot;&quot;, false, false))" id="btnLogin" class="fxt-btn-fill" />
                                          </div>
                                       </div>
                                    </div>
                                 </div>
