...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <form method="post" action="#" id="form1"name="myForm" modelAttribute="saveGroupMasterApplication">
	...
	<option value="504">Indirect Income</option>
                        ...
                        <div class="box-footer">
                            <div class="row col-md-12">
                                ...
                                id="ContentPlaceHolder1_btnSave" onclick="" class="btn btn-success pull-right margin-r-5" />
                            </div>
                        </div>
                    </div>
                </div>
