...
//]]>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="totalInterest" type="text" readonly="readonly" id="totalInterest" class="form-control" PlaceHolder="Enter Total Interest" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="totalPrinciple" type="text" readonly="readonly" id="totalPrinciple" class="form-control" PlaceHolder="Enter Total Principal" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="totalPayble" type="text" readonly="readonly" id="totalPayble" class="form-control" PlaceHolder="Enter Total Payble" />
                                </div>
                            </div>
                    ...
                    <div class="box-body">
                        <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="totalDueAmt" type="text" readonly="readonly" id="totalDueAmt" class="form-control" PlaceHolder="Enter Total Due Amt." />
	...
	<option value="001">Main Office - 001</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="advancePaid" type="text" readonly="readonly" id="advancePaid" class="form-control" PlaceHolder="Enter Advance Paid" />
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group date">
                                        ...
                                        <input name="paymentDate" type="text" value="01/08/2022" id="paymentDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
	...
	<option value="YES">YES</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input name="totalPayableAmt" type="text" readonly="readonly" id="totalPayableAmt" class="form-control" PlaceHolder="Enter Total Payable Amt." />
