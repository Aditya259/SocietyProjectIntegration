...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/LoanApplication.aspx?Type=Approval" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
