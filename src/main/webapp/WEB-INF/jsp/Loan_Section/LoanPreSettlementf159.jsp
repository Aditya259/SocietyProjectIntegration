...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/LoanPreSettlement.aspx?Type=Normal" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
...
//]]>
                    ...
                    <div class="box-body">
                        <div class="col-md-4">
                            <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="payableInterest" type="text" readonly="readonly" id="payableInterest" class="form-control" PlaceHolder="Paid Interest" onkeypress="return isNumberKey(this, event);" autocomplete="off" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="payablePrincipal" type="text" readonly="readonly" id="payablePrincipal" class="form-control" PlaceHolder="Paid Principal" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input name="payableAmount" type="text" readonly="readonly" id="payableAmount" class="form-control" PlaceHolder="Total Paid" onpaste="return false" onkeypress="return isNumberKey(this, event);" autocomplete="off" />
	...
	<option value="001">Main Office - 001</option>
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select name="closingChrg"  id="closingChrg" class="form-control" style="width: 100%;">
	...
	<option value="YES">YES</option>
                                ...
                                <div class="col-sm-3">
                                    <input name="preClosingChages" type="text" value="0" readonly="readonly"  id="preClosingChages" class="form-control" />
                        ...
                        <div class="col-md-4">
                          ...
                          <div id="ContentPlaceHolder1_uppnlcal">
                                ...
                                <div class="col-sm-7">
                                    <input name="totalInterestDue" type="text"  id="totalInterestDue" class="form-control" PlaceHolder="Enter Total Interest Due" autocomplete="off" />
		...
		<option value="SBAccount">SBAccount</option>
                    ...
                    <div class="box-footer">
                        <div class="row col-md-12">
                            ...
                            <input type="submit" name="btnSave" value="Close Loan"  id="btnSave" class="btn btn-success pull-right margin-r-5" />
                        </div>
                    </div>
