...
<body class="skin-blue sidebar-mini" style="height: auto; min-height: 100%; background-color: rgba(36, 105, 92, 0.15);" cz-shortcut-listen="true">
    <form method="post" action="http://admin:eqfi%23123@eqfinidhi.eadmin.in/Admin/IrregularEMIPaymentEntry.aspx?Type=Normal" onsubmit="javascript:return WebForm_OnSubmit();" id="form1">
...
//]]>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                <label for="txtTotalInterest" class="col-sm-5 control-label">Interest Paid<strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="interestPaid" type="text" readonly="readonly" id="interestPaid" class="form-control" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtTotalPrinciple" class="col-sm-5 control-label">Principal Paid<strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="principalPaid" type="text" readonly="readonly" id="principalPaid" class="form-control" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtTotalPayble" class="col-sm-5 control-label">Total Paid <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="totalPaid" type="text" readonly="readonly" id="totalPaid" class="form-control" />
                                </div>
                            </div>
                    ...
                    <div class="box-body">
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="totalInterestDue" type="text" readonly="readonly" id="totalInterestDue" class="form-control" PlaceHolder="Enter Total Interest Due" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="totalPrincipleDue" type="text" readonly="readonly" id="totalPrincipleDue" class="form-control" PlaceHolder="Enter Total Principal Due" />
                            ...
                            <div class="form-group row">
                                <label for="txtAdvancePaid" class="col-sm-5 control-label">Runing Interest <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="curentInterest" type="text" readonly="readonly" id="curentInterest" class="form-control" />

                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtTotalDueAmt" class="col-sm-5 control-label">Total Interest <strong style="color: Red">*</strong></label>
                                <div class="col-sm-7">
                                    <input name="totalInterest" type="text" readonly="readonly" id="totalInterest" class="form-control" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input name="totalDueAmount" type="text" readonly="readonly" id="totalDueAmount" class="form-control" />
	...
	<option value="001">Main Office - 001</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                <label for="ddlDeductLateFine" class="col-sm-5 control-label">Deduct Fine <strong style="color: Red">*</strong></label>
                                <div class="col-sm-4">
                                    <select name="deductLateFine"  id="deductLateFine" class="form-control" style="width: 100%;">
	...
	<option value="YES">YES</option>
                                ...
                                <div class="col-sm-3">
                                    <input name="lateFine" type="text" readonly="readonly" id="lateFine" class="form-control" PlaceHolder="Fine" />
                            ...
                            <div id="ContentPlaceHolder1_uppnlcal">
                                    ...
                                    <div class="form-group row">
                                        <label for="txtPayableAmount" class="col-sm-5 control-label">Pay Amount <strong style="color: Red">*</strong></label>
                                        <div class="col-sm-7">
                                            <input name="payableAmount" type="text"  id="payableAmount" class="form-control" PlaceHolder="Enter Payable Amount" onpaste="return false" autocomplete="off" />
                                    ...
                                    <div class="form-group row">
                                        <label for="txtTotalPayableAmt" class="col-sm-5 control-label">Payable Interest</label>
                                        <div class="col-sm-7">
                                            <input name="payableInterest" type="text" readonly="readonly" id="payableInterest" class="form-control" PlaceHolder="Payable Interest" />
                                    ...
                                    <div class="form-group row">
                                        <label for="txtTotalPayableAmt" class="col-sm-5 control-label">Payable Principal</label>
                                        <div class="col-sm-7">
                                            <input name="payablePrincipal" type="text" readonly="readonly" id="payablePrincipal" class="form-control" PlaceHolder="Payable Principal" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group date">
                                        ...
                                        <input name="payablePrincipalaymentDate" type="text" value="01/08/2022" id="payablePrincipalaymentDate" class="form-control" data-inputmask="&#39;alias&#39;: &#39;dd/mm/yyyy&#39;" data-mask="" />
                                    </div>
                                </div>
                            </div>
		...
		<option value="Flexi">Flexi</option>
                    ...
                    <div class="box-footer">
                        <div class="row col-md-12">
                            ...
                            <input type="submit" name="delete" value="Delete Last Payment"  id="delete" class="btn btn-danger pull-right" />
